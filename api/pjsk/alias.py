...
@cache(expire=300, namespace="pjsk_alias", coder=ORJsonCoder, key_builder=cache_key_builder)  # type: ignore
...
async def add_group_alias(
    ...
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/group/{group_id}/{alias_type}/{alias_type_id}",
    )
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/group/{alias_type}-id",
        query_string=f"alias={data.alias}&group_id={group_id}",
    )
...
async def approve_alias(
    ...
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/{row.alias_type}-id",
        query_string=f"alias={row.alias}",
    )
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/{row.alias_type}/{row.alias_type_id}",
    )
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/status/{pending_id}",
    )
...
async def add_alias(
    ...
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/{alias_type}-id",
        query_string=f"alias={data.alias}",
    )
    await clear_cache_by_path(
        namespace="pjsk_alias",
        path=f"/pjsk/alias/{alias_type}/{alias_type_id}",
    )
